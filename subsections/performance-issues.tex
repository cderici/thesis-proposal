...
together. First I will briefly introduce the formalism, and then
discuss the real implementation on Pycket, as well as a preliminary
experiment to justify the idea.

- Formalism

- Pycket implementation
